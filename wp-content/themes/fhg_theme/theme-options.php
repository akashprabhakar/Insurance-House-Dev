...
////////////////////////////////////////////////////////////////////
    ...
    function dmbs_theme_options_menu() {
        add_theme_page( 'DevDm Theme' . __('Options','fhg_theme'), 'DevDm' . __('Options','fhg_theme'), 'manage_options', 'devdm-theme-options', 'devdm_theme_options' );
    }
    ...
    function toolbar_link_to_dmbs_options( $wp_admin_bar ) {
        $args = array(
            ...
            'title' => __('DevDm Options','fhg_theme'),
...
////////////////////////////////////////////////////////////////////
    ...
    register_default_headers( array(
        'wheel' => array(
            ...
            'description' => __( 'Your Business Name', 'fhg_theme' )
        ))
...
////////////////////////////////////////////////////////////////////
    ...
    if ( !current_user_can( 'manage_options' ) )  {
        ...
        <div class="dm-logo-wrap"><a href="<?php echo $developer_uri ?>" target="_blank"><img src="<?php echo $logo; ?>" class="dm-logo" title="Created by Danny Machal @ DevDm.com" /></a></div>
            ...
            <h2><a href="<?php echo $developer_uri ?>" target="_blank">fhg_theme</a></h2>
               ...
               <div class='saved'><p><strong><?php _e('Options Saved!','fhg_theme') ;?></strong></p></div>
            ...
            <form action="options.php" method="post">
                ...
                <table cellpadding='10'>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Right Sidebar','fhg_theme') ;?></th>
                        <td>
                            <input type="checkbox" id="right_sidebar" name="dm_options[right_sidebar]" value="1" <?php checked( true, $settings['right_sidebar'] ); ?> />
                            <label for="right_sidebar"><?php _e('Show the Right Sidebar','fhg_theme') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Right Sidebar Size','fhg_theme') ;?></th>
                        <td>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Left Side Bar','fhg_theme') ;?></th>
                        <td>
                            <input type="checkbox" id="left_sidebar" name="dm_options[left_sidebar]" value="1" <?php checked( true, $settings['left_sidebar'] ); ?> />
                            <label for="left_sidebar"><?php _e('Show the Left Sidebar','fhg_theme') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Left Sidebar Size','fhg_theme') ;?></th>
                        <td>
                            <?php foreach( $dm_sidebar_sizes as $sizes ) : ?>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Show Header','fhg_theme') ;?></th>
                        <td>
                            <input type="checkbox" id="show_header" name="dm_options[show_header]" value="1" <?php checked( true, $settings['show_header'] ); ?> />
                            <label for="show_header"><?php _e('Show The Main Header in the Template (logo/sitename/etc.)','fhg_theme') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Show Post Meta','fhg_theme') ;?></th>
                        <td>
                            <input type="checkbox" id="show_postmeta" name="dm_options[show_postmeta]" value="1" <?php checked( true, $settings['show_postmeta'] ); ?> />
                            <label for="show_postmeta"><?php _e('Show Post Meta data (author, category, date created)','fhg_theme') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Give Danny His Credit?','fhg_theme') ;?></th>
                        <td>
                            <input type="checkbox" id="author_credits" name="dm_options[author_credits]" value="1" <?php checked( true, $settings['author_credits'] ); ?> />
                            <label for="author_credits"><?php _e('Show me some love and keep a link to DevDm.com in your footer.','fhg_theme') ;?></label>
                        </td>
                    </tr>
                ...
                <p class="submit">
                    <input name="Submit" type="submit" class="button-primary" value="<?php esc_attr_e('Save Changes','fhg_theme'); ?>" />
                </p>
