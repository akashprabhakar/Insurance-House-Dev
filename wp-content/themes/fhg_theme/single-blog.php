...
while (have_posts()) : the_post();
  $eventsdate = date('jS F Y', $custom["fhg_news_startdate"][0]);
  $eventsdate_ar = transfullmonth((date('d F Y', $custom["fhg_news_startdate"][0])));
        ...
        <div class="innerpage">  
          <div class="eventdetailMain">  
            <div class="eventDetpartone">      
              ...
              <div class="borderTop"><h1>aaaaa</h1>&nbsp;</div>
