...
<?php if ($dm_settings['show_postmeta'] != 0) : ?>
    <p class="text-right">
        ...
        <span class="glyphicon glyphicon-edit"></span> <?php edit_post_link(__('Edit','fhg_theme')); ?>
    </p>
    <p class="text-right"><span class="glyphicon glyphicon-circle-arrow-right"></span> <?php _e('Posted In','fhg_theme'); ?>: <?php the_category(', '); ?></p>
    <?php if( has_tag() ) : ?>
