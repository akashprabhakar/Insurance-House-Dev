...
jQuery("#updatedetails").click(function(){            
   ...
   var  oqey_image_arabiclink = encodeURIComponent( jQuery("#updateform #oqey_image_arabiclink").val() );
   var  oqey_arabic_description = encodeURIComponent( jQuery("#updateform #oqey_arabic_description").val() );
   var  oqey_arabic_comments = encodeURIComponent( jQuery("#updateform #oqey_arabic_comments").val() );
   var  youtube_url = encodeURIComponent( jQuery("#updateform #youtube_url").val() );
   var  upload_video = encodeURIComponent( jQuery("#updateform #upload_video").val() );
   ...
   type: "POST",
   url:  ajaxurl,
   data: {action: "oQeyUpdateImageDetails", splash:splash, splashexclusive:splashexclusive, imgid: imgid, galid:galid, alt:alt, comments:comments, oqey_image_link:oqey_image_link ,oqey_image_arabiclink:oqey_image_arabiclink ,oqey_arabic_description : oqey_arabic_description, oqey_arabic_comments :oqey_arabic_comments, youtube_url :youtube_url, upload_video :upload_video },
   success: function(r){
...
<!--   <p><?php _e('Insert Video', 'oqey-gallery'); ?>
    ...
    <label><input type="radio" name="youtubeurl" value="Youtube URL">Youtube Url</label>
  </p> -->
  <p>
          <label>Add Video</label>            
          <input type = "radio"name = "radSize" id = "sizeSmall" value = "youtube" checked = "checked" onclick="videochange(this)" />
          <label for = "sizeSmall">Add Youtube Url</label>
          
          <input type = "radio" name = "radSize" id = "sizeMed" value = "upload" onclick="videochange(this)"/>
          <label for = "sizeMed">Upload Video</label>
 ...
 <!--  <div id="youtubediv">
    <p><?php _e('Youtube Url', 'oqey-gallery'); ?><br />
      <input type="text" name="youtube_url" id="youtube_url" style="width:550px;" value="" /></p>
    <p>
  </div>

  <div id="uploaddiv" style="display:none;"> 
    <p><?php _e('Upload Video', 'oqey-gallery'); ?><br />
      <input id="upload_video" type="text" name="upload_video" style="width:350px;" />
      <button type="button" id="upload-button-oqey" class="button" ><span class="dashicons dashicons-admin-media"></span> Add Video</button>
    <p>
  </div>
