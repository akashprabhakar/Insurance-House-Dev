...
function videochange(video){
    ...
    if(video.value == "youtube"){
      $("#youtubediv").show();
      $("#uploaddiv").hide();
    }

    if(video.value == "upload"){
      $("#uploaddiv").show();
      $("#youtubediv").hide();
    }
}
...
function getGalleryDetails(id){ 
        ...
        var galid = jQuery('#currentGalID').val();
                ...
                if(data.type!="video"){
                   ...
                   jQuery('#detailsimg #oqey_image_arabiclink').val(decodeURIComponent(data.arabiclink));
                   jQuery('#detailsimg #oqey_arabic_description').val(decodeURIComponent(data.arabic_description));
                   jQuery('#detailsimg #oqey_arabic_comments').val(decodeURIComponent(data.arabic_comments));
                   jQuery('#detailsimg #youtube_url').val(decodeURIComponent(data.youtube_url));
                   jQuery('#detailsimg #upload_video').val(decodeURIComponent(data.upload_video));
...
jQuery(document).ready(function($){
  ...
  $('#upload-button-oqey').click(function(e) {
    e.preventDefault();
