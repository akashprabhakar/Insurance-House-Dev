...
function fhg_lp_settings_init(  ) { 
  ...
  add_settings_section(
    'fhg_landingPage_section', 
    __( 'Settings for Landing pages', 'landing_page' ), 
    'fhg_lp_settings_section_callback', 
    'landingPage'
  );

  add_settings_field( 
    'fhg_landing_pages', 
    __( 'Landing Pages', 'landing_page' ), 
    'fhg_landing_pages_render', 
    'landingPage', 
    'fhg_landingPage_section' 
  );
}
