	...
	protected function enqueue_media()
	{
		...
		if ('yes' == $this->options['enable_css'])
		{
			...
			if ('custom' == $this->options['select_theme']
				...
				// load default CSS for FHG Capm Theme
				...
				$form = $this->options['use_recaptcha_v1'] == 'yes' ? array(
					...
					'select' => array(
						'select_theme' => array(
							...
							__('FHG Capm Theme (use CSS)', $this->domain) => 'custom'
						),
						'select_lang' => $this->lang
					),
					'checkbox' => array(
						'cb1' => array(
							sprintf(__('This is for FHG Capm Theme only. '
								. 'Disable this and add your own CSS to style the FHG Capm Theme. '
